...
/*package*/ class DataDictionary_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_r8s0uu_b0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new structuresListHandler_r8s0uu_c0(myNode, getEditorContext());
  ...
  private static class structuresListHandler_r8s0uu_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public structuresListHandler_r8s0uu_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(structuresListHandler_r8s0uu_c0.this.getNode(), LINKS.structures$Wxxz));
      try {
